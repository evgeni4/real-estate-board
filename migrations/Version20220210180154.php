 ...
 */
final class Version20220210180154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties_rooms_widget_amenities ADD checked TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `properties_rooms_widget_amenities` DROP checked');
