 ...
 */
final class Version20220207142232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties ADD period_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE properties ADD CONSTRAINT FK_87C331C7EC8B7ADE FOREIGN KEY (period_id) REFERENCES prices_types (id)');
        $this->addSql('CREATE INDEX IDX_87C331C7EC8B7ADE ON properties (period_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_87C331C7EC8B7ADE ON `properties`');
        $this->addSql('ALTER TABLE `properties` DROP period_id, CHANGE latitude latitude TINYTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE longitude longitude TINYTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE address address VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE video video VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
