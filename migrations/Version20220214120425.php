 ...
 */
final class Version20220214120425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings ADD host_name VARCHAR(255) DEFAULT NULL, ADD user_name VARCHAR(255) DEFAULT NULL, ADD password VARCHAR(255) DEFAULT NULL, ADD port VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings DROP host_name, DROP user_name, DROP password, DROP port');
