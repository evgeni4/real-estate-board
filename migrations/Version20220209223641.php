 ...
 */
final class Version20220209223641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties ADD checked TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE properties_amenities ADD checked TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `properties` DROP checked, CHANGE latitude latitude TINYTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE longitude longitude TINYTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE address address VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE video video VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE `properties_amenities` DROP checked');
