 ...
 */
final class Version20220201161855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties_amenities DROP amenity');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE property_amenities_amenities (property_amenities_id INT NOT NULL, amenities_id INT NOT NULL, INDEX IDX_7521DCD1B92D5262 (amenities_id), INDEX IDX_7521DCD17628A23B (property_amenities_id), PRIMARY KEY(property_amenities_id, amenities_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE `properties_amenities` ADD amenity LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
    }
}
