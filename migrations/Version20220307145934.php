 ...
 */
final class Version20220307145934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pricing_plan ADD uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pricing_plan DROP uuid');
