 ...
 */
final class Version20220221142551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings ADD address VARCHAR(255) DEFAULT NULL');
    }
