 ...
 */
final class Version20220207112626 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE price_type (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, INDEX IDX_F18CA593C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE price_type ADD CONSTRAINT FK_F18CA593C54C8C93 FOREIGN KEY (type_id) REFERENCES types (id)');
