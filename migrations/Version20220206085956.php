 ...
 */
final class Version20220206085956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property_viewed (id INT AUTO_INCREMENT NOT NULL, property_id INT DEFAULT NULL, ip VARCHAR(255) DEFAULT NULL, viewed INT DEFAULT NULL, INDEX IDX_89FF7678549213EC (property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE property_viewed ADD CONSTRAINT FK_89FF7678549213EC FOREIGN KEY (property_id) REFERENCES `properties` (id)');
        $this->addSql('ALTER TABLE properties ADD viewed INT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE property_viewed');
