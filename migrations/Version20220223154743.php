 ...
 */
final class Version20220223154743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings DROP rivacy_policy, DROP terms_of_service');
        $this->addSql('ALTER TABLE settings_translation ADD rivacy_policy LONGTEXT DEFAULT NULL, ADD terms_of_service LONGTEXT DEFAULT NULL');
    }
