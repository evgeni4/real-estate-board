 ...
 */
final class Version20220201092715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `properties_amenities` (id INT AUTO_INCREMENT NOT NULL, amenities_id INT DEFAULT NULL, INDEX IDX_BC5DA08BB92D5262 (amenities_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
