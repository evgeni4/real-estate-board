 ...
 */
final class Version20220221101642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings ADD coming DATETIME DEFAULT NULL, ADD email VARCHAR(255) DEFAULT NULL, ADD phone INT DEFAULT NULL');
    }
