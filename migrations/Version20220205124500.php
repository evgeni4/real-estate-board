 ...
 */
final class Version20220205124500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties_translation CHANGE description description LONGTEXT NOT NULL');
    }
