 ...
 */
final class Version20220223154545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE settings ADD rivacy_policy LONGTEXT DEFAULT NULL, ADD terms_of_service LONGTEXT DEFAULT NULL');
    }
