 ...
 */
final class Version20220306204900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pricing_plan_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, month VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, locale VARCHAR(5) NOT NULL, INDEX IDX_15B4A2AB2C2AC5D3 (translatable_id), UNIQUE INDEX pricing_plan_translation_unique_translation (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE pricing_plan_translation ADD CONSTRAINT FK_15B4A2AB2C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES pricing_plan (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE pricing_plan DROP title, DROP month, DROP description');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE pricing_plan_translation');
        ...
        $this->addSql('ALTER TABLE pricing_plan ADD title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD month VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD description VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
