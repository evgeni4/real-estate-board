 ...
 */
final class Version20220201082055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE properties_amenities ADD property_id INT DEFAULT NULL, ADD amenities INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `properties_amenities` DROP property_id, DROP amenities');
    }
}
