 ...
 */
final class Version20220307122619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pricing_plan ADD recommended TINYINT(1) NOT NULL, ADD count_image INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pricing_plan DROP recommended, DROP count_image');
