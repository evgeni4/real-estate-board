 ...
 */
final class Version20220307130017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pricing_plan CHANGE listing_count listing_count INT DEFAULT NULL, CHANGE days days INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pricing_plan CHANGE listing_count listing_count INT NOT NULL, CHANGE days days INT NOT NULL');
        $this->addSql('ALTER TABLE pricing_plan_translation CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE locale locale VARCHAR(5) NOT NULL COLLATE `utf8mb4_unicode_ci`');
