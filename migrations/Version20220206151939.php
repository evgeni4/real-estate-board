 ...
 */
final class Version20220206151939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE amenities ADD icon_id INT DEFAULT NULL, DROP icon');
        $this->addSql('ALTER TABLE amenities ADD CONSTRAINT FK_EB70547754B9D732 FOREIGN KEY (icon_id) REFERENCES icons (id)');
        $this->addSql('CREATE INDEX IDX_EB70547754B9D732 ON amenities (icon_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE amenities DROP FOREIGN KEY FK_EB70547754B9D732');
        $this->addSql('DROP INDEX IDX_EB70547754B9D732 ON amenities');
        $this->addSql('ALTER TABLE amenities ADD icon VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP icon_id');
        ...
        $this->addSql('ALTER TABLE icons CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE code code VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE property_viewed CHANGE ip ip VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
